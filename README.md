...
This project implements de Prado's ML framework on ETH/USDT, extended with causal discovery as a methodological guardrail. The system predicts **volatility regimes** and sizes positions via fractional Kelly criterion conditioned on regime probabilities.
